 ...
 * @author pacifico
 */
public class PlayVideosUI extends javax.swing.JFrame {
    private MediaSelectorUI m_selector = null;

    public PlayVideosUI(MediaSelectorUI msel) {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Play Videos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Bitstream Vera Sans", 1, 24))); // NOI18N
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(vid.getDono().equals(u.getUsername()) || u.isAdmin()){
            this.setVisible(false);
            new ModifyVideoUI(this, vid).setVisible(true);
        }else{
